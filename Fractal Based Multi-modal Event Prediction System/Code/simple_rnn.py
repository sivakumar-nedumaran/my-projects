...
dataset = np.loadtxt("./dataset_new_short.csv", delimiter=",")
...
X_train = data[:3000,0:33]
X_val = data[3000:,0:33]

Y_train = data[:3000,33:]
Y_val = data[3000:,33:]
y_true = Y_val
...
# create model
model = Sequential()
model.add(Dense(512, input_dim=33, activation='relu'))
