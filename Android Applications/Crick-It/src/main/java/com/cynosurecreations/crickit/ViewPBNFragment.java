...
public class ViewPBNFragment extends Fragment {

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.view_pbn_layout,null);
        ...
        ((Button) view.findViewById(R.id.buttonViewSBN)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //pass.show();
                ((PlayerMainActivity)getActivity()).playerid=playerid;
