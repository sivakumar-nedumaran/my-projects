...
public class ViewPBLFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.view_pbl_layout,null);
        ...
        ((Button) view.findViewById(R.id.buttonViewSBC)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((PlayerMainActivity)getActivity()).viewAreaPlayers();
